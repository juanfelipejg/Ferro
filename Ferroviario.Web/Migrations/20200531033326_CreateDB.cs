        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    FirstDriverId = table.Column<string>(nullable: true),
                    FirstDriverServiceId = table.Column<int>(nullable: true),
                    SecondDriverId = table.Column<string>(nullable: true),
                    SecondDriverServiceId = table.Column<int>(nullable: true),
                    State = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Changes_ShiftEntity_FirstDriverServiceId",
                        column: x => x.FirstDriverServiceId,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Changes_ShiftEntity_SecondDriverServiceId",
                        column: x => x.SecondDriverServiceId,
                        principalTable: "ShiftEntity",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
