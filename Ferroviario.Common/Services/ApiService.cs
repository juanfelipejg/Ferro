...
namespace Ferroviario.Common.Services
{
    public class ApiService : IApiService
    {
        ...
        public async Task<Response> GetShiftsForUserAsync(string urlBase, string servicePrefix, string controller, ShiftsForUserRequest shiftsForUserRequest, string tokenType, string accessToken)
        {
            try
            {
                string request = JsonConvert.SerializeObject(shiftsForUserRequest);
                StringContent content = new StringContent(request, Encoding.UTF8, "application/json");
                HttpClient client = new HttpClient
                {
                    BaseAddress = new Uri(urlBase)
                ...
                List<ShiftResponse> list = JsonConvert.DeserializeObject<List<ShiftResponse>>(result);
                return new Response
                {
                    IsSuccess = true,
                    Result = list
        ...
        public async Task<Response> GetShiftsForChangeAsync(string urlBase, string servicePrefix, string controller, ShiftsForUserRequest shiftsForUserRequest, string tokenType, string accessToken)
        {
            try
            {
                string request = JsonConvert.SerializeObject(shiftsForUserRequest);
        ...
        public async Task<Response> GetChangesForUserAsync(string urlBase, string servicePrefix, string controller, ChangesForUserRequest changesForUserRequest, string tokenType, string accessToken)
        {
            try
            {
                string request = JsonConvert.SerializeObject(changesForUserRequest);
                StringContent content = new StringContent(request, Encoding.UTF8, "application/json");
                HttpClient client = new HttpClient
                {
                    BaseAddress = new Uri(urlBase)
                ...
                List<ChangeResponse> list = JsonConvert.DeserializeObject<List<ChangeResponse>>(result);
                return new Response
                {
                    IsSuccess = true,
                    Result = list
        ...
        public async Task<Response> CreateChangeAsync(string urlBase, string servicePrefix, string controller, ChangeRequest changeRequest, string tokenType, string accessToken)
        {
            try
            {
                string request = JsonConvert.SerializeObject(changeRequest);
                StringContent content = new StringContent(request, Encoding.UTF8, "application/json");
                HttpClient client = new HttpClient
                {
                    BaseAddress = new Uri(urlBase)
